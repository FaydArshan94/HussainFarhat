  ...
  return (
    <div className="w-full min-h-screen bg-black text-white font-['Superset'] flex flex-col mdsm:flex-row mdsm:gap-20 md:gap-2 lg:gap-[2rem] xl:gap-[5rem] 3xl:gap-[8rem] items-start justify-start lg:justify-between 3xl:justify-center px-4 md:px-10 py-10 3xl:px-60 3xl:py-20">
      ...
      <div className="w-full max-w-[1400px] 3xl:max-w-[1600px]  sm:h-full mb-12 sm:mt-20 2xl:w-[70%">
        ...
        <p className="text-[1rem] font-['light'] xs:w-[60vw] mdsm:w-[50vw] mdsm:text-[1rem] md:w-full lg:w-[85%] 3xl:text-[1.5rem] 3xl:leading-[2.5rem] leading-snug font-light text-white mt-6">
        ...
        <button className="mt-6 font-['light'] text-[1.5rem] xs:text-[1rem] mdsm:text-[1.3rem] 3xl:text-[2rem] tracking-tight font-light border-b-4 border-[#890900] text-white hover:text-[#0058FF] hover:border-white transition-all duration-200 uppercase">
          Start Your Journey
        </button>
      </div>
          ...
          <div className="flex flex-col gap-4 w-full  md:w-[45vw]  xl:h-[70vh]  xl:w-full 3xl:w-1/2 md:flex-row md:flex-wrap md:justify-center 3xl:justify-center">
            {[
              ...
              >
                ...
                >
                  <h2 className="text-3xl md:text-[1.1rem] 3xl:text-[1.6rem] tracking-widest text-white mb-2 md:mb-0">
                    {item.label}
                  </h2>
