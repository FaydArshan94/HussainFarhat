...
const Page7 = () => {
  return (
    <div className="relative w-full min-h-[55vh] flex items-center justify-center bg-white/30  text-white px-4 py-10 overflow-hidden sm:h-[70vh]">
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2  -translate-y-1/2 w-full h-full z-0 flex flex-col gap-4 opacity-[0.05] pointer-events-none">
        {Array.from({ length: 3 }).map((_, i) => (
          <h1
            key={i}
            className="whitespace-nowrap text-[10rem] sm:leading-[25vh] font-['Superset'] text-white  tracking-normal sm:text-[12rem]"
          >
