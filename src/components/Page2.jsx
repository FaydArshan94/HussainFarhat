      ...
      <div className="relative mt-[20rem]  z-10 flex flex-col mdsm:flex-row mdsm:justify-between mdsm:gap-5 w-full mdsm:mt-[20rem] md:mt-[30rem]">
        ...
        >
          {["EXPERIENCE","THE BENEFITS", "OF PERSONAL", "TRAINING"].map((line, i) => (
            <h1
              key={i}
              className="text-[5rem] leading-[6rem] tracking-wide 2sm:text-[6rem] md:text-[7rem] lg:text-[7.5rem] lg:leading-[8.5rem] xl:text-[7.5rem] xl:leading-[8.5rem] 2xl:text-[9rem] 3xl:text-[14rem] text-left overflow-hidden"
            >
